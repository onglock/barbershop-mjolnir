...
/* Прилёт (этап 2, десктопная ветка): те же тайминги, что у 2D-молота на мобильном.
   ...
   −16 — компромисс между дистанцией и видимостью (центр ≈ −1620 px, бокс
   ≈ −1645…−1595; вход в кадр ≈58 % пути). История: −8,4 (вход 22 %), −18,8
   (вход 65 %, слишком долго пустой кадр). */
const FLIGHT_START_X = -16;
